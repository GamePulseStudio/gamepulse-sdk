...
exports.mockNetworkError = exports.mockFetchError = exports.mockFetchSuccess = void 0;
...
var mockFetchSuccess = function (data, status) {
    if (data === void 0) { data = {}; }
...
var mockFetchError = function (error) {
    fetch.mockRejectedValueOnce(error);
};
exports.mockFetchError = mockFetchError;
// Helper function to mock network failures
var mockNetworkError = function () {
    (0, exports.mockFetchError)(new Error('Network error'));
};
