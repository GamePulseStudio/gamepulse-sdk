...
var WebUsageExample = /** @class */ (function () {
    ...
    WebUsageExample.prototype.sessionManagement = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return WebUsageExample;
}());
// Usage
var example = new WebUsageExample();
// Initialize when the page loads
document.addEventListener('DOMContentLoaded', function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, example.initializeSDK()];
            case 1:
                _a.sent();
                example.trackEvents();
...
exports.default = WebUsageExample;
